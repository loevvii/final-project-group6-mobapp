...
const UserDashboard: React.FC = () => {
 ...
 return (
    <View>
        <Text> 
            //style would be header
            User Dashboard
        </Text>

        <Text>
            // selecting a calendar would check appointment exists ? view details : set appointment date.
            // if view details, request cancellation should be available
            Calendar View
        </Text>
    </View>
  );
